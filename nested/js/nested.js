...
document.querySelector('#asteroid').innerHTML = "The asterois named " + asteroid.name + " is between " + asteroid.estimated_diameter.miles.estimated_diameter_min + " and " + asteroid.estimated_diameter.miles.estimated_diameter_max + " miles wide, and will mis striking Earth by approximately " +asteroid.close_approach_data[0].miss_distance.miles + " miles." 

document.querySelector('#link').innerHTML = "<a href= '" + asteroid.links.self + "'>link</a>"
